...
int main(){
	std::string s = "Write a program\nusing a series of\tif statements to count the number of vowels in text read from cin";

	int a_cnt = 0, e_cnt = 0, i_cnt = 0, o_cnt = 0, u_cnt = 0, nl_cnt = 0, sp_cnt = 0, tab_cnt = 0;
	...
	std::cout << "No. of new lines in string are : " << nl_cnt << std::endl;
	std::cout << "No. of spaces in string are : " << sp_cnt << std::endl;
	std::cout << "No. of tabs in string are : " << tab_cnt << std::endl;
