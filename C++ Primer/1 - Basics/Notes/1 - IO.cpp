...
// iostream : istrea + ostream
// so the iostream library also the input output stream library defines 4 objects for the basic I/O functionality
    ...
    // cerr is also used to output to the console but it is unbuffered and don't hold the message in its memory also called standard error
